# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-12-11 12:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=128, null=True, verbose_name='商品评论')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.Books', verbose_name='订单商品')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Recipient', verbose_name='收件信息')),
            ],
            options={
